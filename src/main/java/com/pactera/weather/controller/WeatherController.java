...
import com.pactera.weather.service.WeatherApiService;
...
public class WeatherController {
	...
	public WeatherController(ApiConfig apiConfig, WeatherApiService weatherService, CityService cityService) {
...
//		request.setCountry(optCity.get().getCountry());
		...
		WeatherApiData weatherData = weatherService.getWeatherInfo(request);
